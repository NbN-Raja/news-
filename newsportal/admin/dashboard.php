...
?>
    ...
    <body class="fixed-left">
        ...
        <div id="wrapper">
            ...
            <div class="content-page">
                ...
                <div class="content">
                            ...
                            <a href="manage-posts.php">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
                                            <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Total News</p>
                            ...
                            <a href="add-ads.php">
                                <div class="col-lg-4 col-md-4 col-sm-6">
                                    <div class="card-box widget-box-one">
                                        <i class="mdi mdi-layers widget-one-icon"></i>
                                        <div class="wigdet-one-content">
                                            <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">Total Advertisement </p>
                                            <?php $query = mysqli_query($con, "select * from tblads");
                                            $countposts = mysqli_num_rows($query);
                                            ?>
                                            <h2><?php echo htmlentities($countposts); ?> <small></small></h2>
                    ...
                    <div class="">
                        ...
                        $query = "SELECT PostTitle,viewCounter FROM tblposts WHERE Is_Active = 1";
                        ...
                        // Iterate through the query result and populate the arrays
                        while ($row = mysqli_fetch_assoc($result)) {
                            $labels[] = substr($row['PostTitle'], 0, 15);
                            $data[] = $row['viewCounter'];
                        }
                                ...
                                var chart = new Chart(ctx, {
                                    ...
                                    data: {
                                        ...
                                        datasets: [{
                                            label: 'Views',
                                            data: data,
                                            backgroundColor: ['rgba(75, 192, 192, 0.2)', 'rgba(255, 0, 0, 0.5)', 'rgba(0, 128, 0, 0.3)'],
                                              borderColor: ['rgba(80, 150, 200, 1)', 'rgba(255, 0, 0, 1)', 'rgba(0, 128, 0, 1)'],
            ...
            <!-- Right Sidebar -->
            <!-- <div class="side-bar right-bar bg-dark">
