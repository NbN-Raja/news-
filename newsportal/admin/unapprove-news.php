...
<?php
$query=mysqli_query($con,"select * from tblusernews ");
...
?>
 <tr>
<td><b><?php echo htmlentities($row['pagetitle']);?></b></td>
<td><?php echo htmlentities($row['pagedescription'])?></td>
<td><?php echo htmlentities($row['name'])?></td>

<td><a href="unapprove-newsedit.php?pid=<?php echo htmlentities($row['id']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
