...
if (isset($_POST['submit_nav'])) {
    ...
    if ($nav['error'] === UPLOAD_ERR_OK) {
        ...
        if (move_uploaded_file($image_tmp, $image_path)) {
            ...
            $query = mysqli_query($con, "INSERT INTO tblads (nav) VALUES ('$image_name')");
...
if (isset($_POST['update'])) {
    $nav = $_FILES['nav']['name'];  // Extract the file name from the $_FILES array
    $id = $_POST['id'];
$sql = "UPDATE tblads SET nav = '$nav' where id='$id'";
