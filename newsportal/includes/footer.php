...
<div class="container-fluid bg-dark pt-5 px-sm-3 px-md-5 mt-5">
    <div class="row py-4">
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            ?>
                ...
                <div class="mb-3">
                    ...
                    <a class="small text-body text-uppercase font-weight-medium" href="news-details.php?nid=<?php echo htmlentities($result['pid']) ?>"> <?php $title = htmlentities($result['posttitle']);
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            ?>
                ...
                <div class="m-n1">
                    <div class="btn btn-sm btn-secondary m-1" href="category.php?catid=<?php echo htmlentities($row['id']) ?>"><?php echo htmlentities($row['CategoryName']); ?></div>
                </div>
    ...
    <div class="row">
        ...
        $sql = "SELECT PostImage FROM tblposts limit 6";
        ...
        if ($results->num_rows > 0) {
            while ($row = $results->fetch_assoc()) {
                ...
                // Open a new column div for every 3rd image
                if ($counter % 3 === 0) {
                    echo '</div>
                    <div class="row ">';
                }
                
                echo '<div class="col-4 mb-3 shadow">';
                echo '<img class="w-100 h-100 img-fluid object-fit-cover" src="./admin/postimages/' . htmlentities($postImage) . '" alt="">';
                echo '</div>';
